...
<div class="row">
	<div class="" style="position: absolute;width:100%;left:0;">
		<div id="menu_add_route">
			...
			<img src="<?php echo base_url();?>assets/img/edit_route.png" onclick="editPoly()" id="" width="40" data-tooltip="Edit Route"/>
	...
	<div class="col-md-3" style="position:absolute;right:0;bottom:0;margin-right:30px;padding:0;margin-top:99px;top:0;">
		<div class="add-route-form">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<textarea class="form-control" rows="3" id="route_info" readonly></textarea>
				</div>
			</div>
			<div class="clearfix"></div>
			<div class="row">
