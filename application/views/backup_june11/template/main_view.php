      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="<?php echo ($active == "routes" || $uri1 == "google" && $active=="" || $active == 'fetch_waypoints')? 'active-li': NULL;?>">
              <a href="<?php echo base_url("google/routes");?>" >Route</a>
            </li>
            <li class="<?php echo ($active == "hazard_list" || $active == "add_hazard")? 'active-li': NULL;?>">
              <a href="<?php echo base_url("google/hazard_list");?>" >Hazard</a>
            </li>
            ...
            <li class="log-btn">
              <a href="<?php echo base_url("login/logout");?>" class="text-right btn btn-primary" id="logout-btn">Logout</a>
            </li>
          </ul>
        </div>
      </div>
...
<script type="text/javascript" src="<?php #echo base_url();?>assets/js/findintersections.js"></script>-->
