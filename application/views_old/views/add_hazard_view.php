...
<div class="">	
	<div class="">
		...
		<div id="map" style="width: 100%; height: 675px;position:absolute!important;left:0;top:0;">
      ...
      <div class="modal-body">
		<form class="form-horizontal" id="add_hazard_form" enctype="multipart/form-data" role="form">
		  ...
		  <div class="form-group">
		  		...
		  		<div class="col-sm-9" id="icon-container">
					...
					<div id="road" class="icon-list">
						...
						<div data-tooltip="Ped-xing" class="icon" style="background-image:url(../assets/img/icons/ped-xing.png)" id="ped-xing.png"></div>
		  ...
		  <div class="form-group" id="site-upload">
			<label for="image" class="col-sm-2 control-label">Site Photo</label>
			<div class="col-sm-6">
