...
<div class="">	
	<div class="">
		<div id="menu_add_route">
			...
			<img src="<?php echo base_url();?>assets/img/back.png" onclick='window.location = "<?php echo base_url();?>google/hazard_list";' width="40" data-tooltip="Back" />
		</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="margin-bottom:-10px;padding-bottom:6px;">
        ...
        <h4 class="modal-title" id="myModalLabel">Hazard Information</h4>
      </div>
      <div class="modal-body">
		<form class="form-horizontal" id="add_hazard_form" enctype="multipart/form-data" role="form" style="font-size:12px;">
		  ...
		  <div class="form-group">
		  		<label for="icon" class="col-sm-2 control-label">Icon Category</label>
		  		<div class="col-sm-3">
      ...
      <div class="modal-footer" style="margin-top:-10px;padding-top:8px;">
        ...
        <button type="submit" class="btn btn-primary btn-sm" onclick="" id='_submit'>Save changes</button>
      </div>
      </form>
    </div>
  </div>
