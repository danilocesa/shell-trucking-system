...
//url for ajax
  ...
  var user_lat = <?php echo $this->dan_model->select_where("user_tb",array("user_id"=>get_session("login")['user_id']))->latitude;?>;
  var user_lng = <?php echo $this->dan_model->select_where("user_tb",array("user_id"=>get_session("login")['user_id']))->longtitude;?>;
